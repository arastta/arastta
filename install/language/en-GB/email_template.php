...
$_['order_id']         = '<b>Order ID :</b> {order_id}';
$_['date_added']       = '<b>Date Added :</b> {date}';
$_['payment_method']   = '<b>Payment Method :</b> {payment}';
$_['shipping_method']  = '<b>Shipping Method :</b> {shipment}';
$_['email']            = '<b>E-mail :</b> {email}';
$_['telephone']        = '<b>Telephone :</b> {telephone}';
$_['ip_address']       = '<b>IP Address :</b> {ip}';
$_['oder_status']      = '<b>Order Status :</b> {status_name}';
...
$_['affiliate_2_affiliate_user']     = 'Your Affiliate user : {email}';
$_['affiliate_2_affiliate_password'] = 'Your Affiliate password : {password}';
...
$_['contact_1_contact'] = 'Contact {email}';
$_['contact_1_message'] = 'Contact Message: {enquiry}';
...
$_['customer_3_username']        = 'Your user name: {email}';
$_['customer_3_password']        = 'Your password : {password}';
...
$_['invoice_2_invoice_no']      = 'Invoice No.: {invoice_no}';
$_['invoice_2_invoice_date']    = 'Invoice Date: {date_added}';
