...
class ModelSettingStore extends Model {
    public function addStore($data) {
        $this->trigger->fire('pre.admin.store.add', array(&$data));
        ...
        $this->trigger->fire('post.admin.store.add', array(&$store_id));

        return $store_id;
    }

    public function editStore($store_id, $data) {
        $this->trigger->fire('pre.admin.store.edit', array(&$data));
        ...
        $this->trigger->fire('post.admin.store.edit', array(&$store_id));
    }

    public function deleteStore($store_id) {
        $this->trigger->fire('pre.admin.store.delete', array(&$store_id));
        ...
        $this->trigger->fire('post.admin.store.delete', array(&$store_id));
    }
