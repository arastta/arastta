...
$_['help_tax_default']                 = 'Use the store address to calculate taxes customer is not logged in. You can choose to use the store address for the customer\'s shipping or payment address.';
