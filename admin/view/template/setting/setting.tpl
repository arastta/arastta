          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-mail">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_mail[smtp_password]" value="<?php echo $config_smtp_password; ?>" <?php echo ($config_mail_protocol == 'smtp') ? '' : 'disabled="disabled"' ?> placeholder="<?php echo $entry_smtp_password; ?>" id="input-smtp-password" class="form-control" />
                </div>
              </div>
              <div class="form-group">
