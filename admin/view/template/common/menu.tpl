<ul id="menu">
  ...
  <?php } ?>
  <?php
  if( $preturn_order != false || $preturn_order_recurring != false || $preturn_return != false || $preturn_customer != false || $preturn_customer_group != false || $preturn_customer_ban_ip != false || $preturn_custom_field != false || $preturn_paypal != false ) {
  ?>
  ...
  <?php } ?>
  <?php
  if( $preturn_customer != false || $preturn_customer_group != false || $preturn_customer_ban_ip != false || $preturn_custom_field != false ) {
  ?>
  ...
  <?php } ?>
  <?php
  if( $preturn_marketing != false || $preturn_affiliate != false || $preturn_coupon != false || $preturn_voucher != false || $preturn_voucher_theme != false || $preturn_contact != false ) {
  ?>
  ...
  <li><a class="parent"><?php echo $text_marketing; ?></a>
    ...
    <?php } ?>
    <?php
      if( $preturn_appearance_customizer != false ||  $preturn_appearance_layout != false || $preturn_appearance_menu != false ||  $preturn_design_banner != false ) {
      ?>
...
<?php } ?>
<?php
  if( $preturn_setting != false || $preturn_user != false || $preturn_user_permission != false || $preturn_user_api != false || $preturn_email_template != false || $preturn_language_override != false ) {
  ?>
  ...
  <?php } ?>
    <?php
      ...
      ?>
    <li id="system"><a class="parent"><i class="fa fa-wrench fa-fw"></i> <span><?php echo $text_tools; ?></span></a>
        <ul class="collapse">
