<div id="content" class="show-all-content">
        ...
        <div class="content">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="show-all-tag-language<?php echo $language['language_id']; ?>">
                    ...
                    <a id="<?php echo $type . '-' . $item[$type . '_id']; ?>" class="bg-info"><?php echo $value; ?> <i class="fa fa-times-circle"></i></a>
                    <?php } else { ?>
                    <a id="<?php echo $type . '-' . $item[$type . '_id']; ?>" class="bg-success"><?php echo $value; ?></a>
                    <?php } ?>
                    <?php } ?>
                </div>
                <?php } ?>
