    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
                <button type="button" data-toggle="tooltip" title="<?php echo $button_approve; ?>" class="btn btn-default" onclick="$('form').attr('action', '<?php echo $approve; ?>'); $('form').submit();"><i class="fa fa-thumbs-o-up text-success"></i></button>
