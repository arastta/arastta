  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <div class="pull-right">
        ...
        <a href="<?php echo $installer; ?>" data-toggle="tooltip" title="<?php echo $button_installer; ?>" class="btn btn-default" data-original-title="<?php echo $button_installer; ?>"><i class="fa fa-upload"></i></a>
