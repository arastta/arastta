...
<div id="content">
                  ...
                  <td style="width: 70px;" class="text-center">
                    <div class="bulk-action-activate">
                      ...
                      <ul class="dropdown-menu dropdown-menu-left alerts-dropdown">
                        ...
                        <li><button type="submit" id="button-shipping" form="form-order" formaction="<?php echo $shipping; ?>"><i class="fa fa-truck"></i> <?php echo $button_shipping_print; ?></button></li>
                        <li><button type="submit" id="button-invoice" form="form-order" formaction="<?php echo $invoice; ?>"><i class="fa fa-print"></i> <?php echo $button_invoice_print; ?></button></li>
                        <li><button type="submit" id="button-invoicepdf" form="form-order" formaction="<?php echo $invoicepdf; ?>"><i class="fa fa-file-pdf-o"></i> <?php echo $button_invoice_pdf; ?></button></li>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left">
                    ...
                    <a href="<?php echo $order['edit']; ?>"><i class="fa fa-pencil"></i></a>
                    <a href="<?php echo $order['delete']; ?>" id="button-delete<?php echo $order['order_id']; ?>"><i class="fa fa-trash-o"></i></a>
  ...
  $('input[type=\'checkbox\']').click (function() {
    var checkboxs = $('#form-order input[type=\'checkbox\']');
    var selected = 0;
    ...
    if (selected) {
      ...
      $('.item-selected').html(selected + ' <?php echo $text_selected_order; ?>');
    } else {
      $('.table-name').show();
