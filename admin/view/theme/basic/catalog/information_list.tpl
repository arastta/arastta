              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($information['information_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left">
					<a href="<?php echo $information['edit']; ?>"><i class="fa fa-pencil"></i></a>
...
$(document).ready(function() {
  $('input[type=\'checkbox\']').click (function() {
    var checkboxs = $('#form-information input[type=\'checkbox\']');
    var selected = 0;
    ...
    if (selected) {
      ...
      $('.item-selected').html(selected + ' <?php echo $text_selected_information; ?>');
    } else {
      $('.table-name').show();
