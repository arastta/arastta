...
<div id="content">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="well" style="display:none;">
                            ...
                            <div class="input-group">
                                <div class="input-group-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="filter-list-type" onclick="changeFilterType('<?php echo $entry_status; ?>', 'filter_return_status_id');"><?php echo $entry_status; ?></a></li>
                                    </ul>
                                </div>
                                ...
                                <select name="filter_return_status_id" id="input-status" class="form-control filter hidden">
                    ...
                    <?php if (!empty($filter_date_start) || !empty($filter_date_end) || !empty($filter_group) || isset($filter_return_status_id)) { ?>
                    <div class="row">
    ...
    $(document).ready(function() {
        ...
        changeFilterType('<?php echo $entry_status; ?>', 'filter_return_status_id');
        <?php } ?>
    });
