...
<div id="content">
                            ...
                            <div class="input-group">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-default dropdown-toggle basic-filter-button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="filter-type"><?php echo $entry_affiliate; ?></div> <span class="caret"></span>
                                    </button>
                                ...
                                <input type="text" name="filter_affiliate" value="<?php echo $filter_affiliate; ?>" placeholder="<?php echo $text_filter . $entry_affiliate; ?>" id="input-affiliate" class="form-control filter" />
                                ...
                                <div class="input-group date filter hidden filter hidden filter_date_start">
                                  <input type="text" name="filter_date_start" value="<?php echo $filter_date_start; ?>" placeholder="<?php echo $text_filter . $entry_date_start; ?>" data-date-format="YYYY-MM-DD" id="input-date-start" class="form-control filter hidden" />
    ...
    $(document).ready(function() {
        <?php if (!empty($filter_affiliate)) { ?>
        changeFilterType('<?php echo $entry_affiliate; ?>', 'filter_affiliate');
