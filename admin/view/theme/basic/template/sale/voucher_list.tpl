                  ...
                  <div class="bulk-action">
					...
					<span class="bulk-action-button">
					  ...
					  <ul class="dropdown-menu dropdown-menu-left alerts-dropdown">
						...
						<li><a onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-voucher').submit() : false;"><i class="fa fa-trash-o"></i> <?php echo $button_delete; ?></a></li>
					  </ul>
					</span>
                  </div></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($voucher['voucher_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left">
					<a href="<?php echo $voucher['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>"><i class="fa fa-pencil"></i></a>
					<?php echo $voucher['code']; ?></td>
...
$(document).ready(function() {
  $('input[type=\'checkbox\']').click (function() {
    var checkboxes = $('#form-voucher input[type=\'checkbox\']');
    var selected = 0;
