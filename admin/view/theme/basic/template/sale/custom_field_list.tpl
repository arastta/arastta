              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($custom_field['custom_field_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left">
					<a href="<?php echo $custom_field['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>"><i class="fa fa-pencil"></i></a>
...
$(document).ready(function() {
  $('input[type=\'checkbox\']').click (function() {
    var checkboxes = $('#form-custom-field input[type=\'checkbox\']');
    var selected = 0;
