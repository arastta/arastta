                        ...
                        <table class="table table-hover">
                                    ...
                                    <div class="bulk-action">
                                        ...
                                        <span class="bulk-action-button">
                                          ...
                                          <ul class="dropdown-menu dropdown-menu-left alerts-dropdown">
                                              ...
                                              <li><a onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-voucher-theme').submit() : false;"><i class="fa fa-trash-o"></i> <?php echo $button_delete; ?></a></li>
                                          </ul>
                                        </span>
                                    </div></td>
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($voucher_theme['voucher_theme_id'], $selected)) { ?>
                                    ...
                                    <?php } ?></td>
                                <td class="text-left">
                                    <a href="<?php echo $voucher_theme['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary btn-sm btn-basic-list"><i class="fa fa-pencil"></i></a>
                                    <?php echo $voucher_theme['name']; ?></td>
                            </tr>
                            <?php } ?>
                            <?php } else { ?>
                            <tr>
