              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($voucher_theme['voucher_theme_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left">
					<a href="<?php echo $voucher_theme['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>"><i class="fa fa-pencil"></i></a>
...
$(document).ready(function() {  
  $('input[type=\'checkbox\']').click (function() {
    var checkboxes = $('#form-voucher-theme input[type=\'checkbox\']');
    var selected = 0;
