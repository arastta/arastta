<div class="form-group">
    <label class="col-sm-3 control-label"><?php echo $entry_account; ?></label>
    <div class="col-sm-9"><?php echo $email; ?></div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label"><?php echo $entry_key; ?></label>
    <div class="col-sm-9"><?php echo $key; ?></div>
    <input type="hidden" name="params[twofactorauth][googleauth][key]" value="<?php echo $key; ?>" />
</div>
<div class="form-group">
    <label class="col-sm-3 control-label"><?php echo $entry_qrcode; ?></label>
    <div class="col-sm-9"><?php echo '<img src="data:image/png;base64,'.base64_encode($qrcode).'"/>'; ?></div>
</div>
<?php if ($new) { ?>
<div class="form-group">
