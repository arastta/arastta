                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-information">
                    <div class="table-responsive">
                        <table class="table table-hover">
							...
							<?php } else { ?>
							<tbody>
								<input type="hidden" name="sort_order_type"  id="sort-order-type" value="i.sort_order" class="form-control"/>
							<?php } ?>
                            <?php if ($informations) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php if (in_array($information['information_id'], $selected)) { ?>
                                    ...
                                    <?php } ?></td>
                                <td class="text-left">
                                    <a href="<?php echo $information['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary btn-sm btn-basic-list"><i class="fa fa-pencil"></i></a>
                                    <?php echo $information['title']; ?>
                                </td>
								<td class="hidden">
									<input type="hidden" name="items[sort_order][]" value="<?php echo $information['information_id']; ?>" class="form-control"/>
								</td>
                            </tr>
                            <?php } ?>
                            <?php } else { ?>
