              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($return_reason['return_reason_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left">
					<a href="<?php echo $return_reason['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>"><i class="fa fa-pencil"></i></a>
					<?php echo $return_reason['name']; ?></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$(document).ready(function() {
  $('input[type=\'checkbox\']').click (function() {
    var checkboxes = $('#form-return-reason input[type=\'checkbox\']');
    var selected = 0;
