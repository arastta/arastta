                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($return_reason['return_reason_id'], $selected)) { ?>
                                    ...
                                    <?php } ?></td>
                                <td class="text-left">
                                    <a href="<?php echo $return_reason['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary btn-sm btn-basic-list"><i class="fa fa-pencil"></i></a>
