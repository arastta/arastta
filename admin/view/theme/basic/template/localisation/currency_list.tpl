  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
		<a href="<?php echo $refresh; ?>" data-toggle="tooltip" title="<?php echo $button_currency; ?>" class="btn btn-default"><i class="fa fa fa-refresh"></i></a> 
				  ...
				  <div class="bulk-action">
					...
					<span class="bulk-action-button">
					  ...
					  <ul class="dropdown-menu dropdown-menu-left alerts-dropdown">
						...
						<li><a onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-currency').submit() : false;"><i class="fa fa-trash-o"></i> <?php echo $button_delete; ?></a></li>
					  </ul>
					</span>
                  </div></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($currency['currency_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left">
					<a href="<?php echo $currency['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>"><i class="fa fa-pencil"></i></a>
					<?php echo $currency['title']; ?></td>
...
$(document).ready(function() {
  $('input[type=\'checkbox\']').click (function() {
    var checkboxes = $('#form-currency input[type=\'checkbox\']');
    var selected = 0;
