                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="payment-detail">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="input-commission"><span data-toggle="tooltip" title="<?php echo $help_commission; ?>"><?php echo $entry_commission; ?></span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="input-tax"><?php echo $entry_tax; ?></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="tax" value="<?php echo $tax; ?>" placeholder="<?php echo $entry_tax; ?>" id="input-tax" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo $entry_payment; ?></label>
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            <label>
                                ...
                                <div id="payment-cheque" class="payment">
                                    <div class="form-group required">
                                        <label class="col-sm-3 control-label" for="input-cheque"><?php echo $entry_cheque; ?></label>
                                        <div class="col-sm-9">
                                ...
                                <div id="payment-paypal" class="payment">
                                    <div class="form-group required">
                                        <label class="col-sm-3 control-label" for="input-paypal"><?php echo $entry_paypal; ?></label>
                                        <div class="col-sm-9">
                                ...
                                <div id="payment-bank" class="payment">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input-bank-name"><?php echo $entry_bank_name; ?></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input-bank-branch-number"><?php echo $entry_bank_branch_number; ?></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input-bank-swift-code"><?php echo $entry_bank_swift_code; ?></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group required">
                                        <label class="col-sm-3 control-label" for="input-bank-account-name"><?php echo $entry_bank_account_name; ?></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group required">
                                        <label class="col-sm-3 control-label" for="input-bank-account-number"><?php echo $entry_bank_account_number; ?></label>
                                        <div class="col-sm-9">
