    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button id="button-send" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $button_send; ?>" class="btn btn-default" onclick="send('index.php?route=marketing/contact/send&token=<?php echo $token; ?>');"><i class="fa fa-envelope"></i></button>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="general">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-12" for="input-to"><?php echo $entry_to; ?></label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group to" id="to-customer">
                                    <label class="col-sm-12" for="input-customer"><span data-toggle="tooltip" title="<?php echo $help_customer; ?>"><?php echo $entry_customer; ?></span></label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group required">
                                    <label class="col-sm-12" for="input-subject"><?php echo $entry_subject; ?></label>
                                    <div class="col-sm-12">
