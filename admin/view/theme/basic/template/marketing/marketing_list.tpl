...
<div id="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="filter_code"  value="<?php echo $filter_code; ?>" placeholder="<?php echo $text_filter . $entry_code; ?>" id="input-code" class="form-control filter hidden">
    ...
    $(document).ready(function() {
        ...
        changeFilterType('<?php echo $entry_code; ?>', 'filter_code');
