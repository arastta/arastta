$( document ).ready(function() {
    ...
    $('input[name=\'filter_category_name\']').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'index.php?route=appearance/menu/autocomplete&token=' + token + '&filter_category_name=' +  encodeURIComponent(request),
                dataType: 'json',
    ...
    $('input[name=\'filter_product_name\']').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'index.php?route=appearance/menu/autocomplete&token=' + token + '&filter_product_name=' +  encodeURIComponent(request),
                dataType: 'json',
                success: function(json) {
                    response($.map(json, function(item) {
                        return {
    ...
    $('input[name=\'filter_manufacturer_name\']').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'index.php?route=appearance/menu/autocomplete&token=' + token + '&filter_manufacturer_name=' +  encodeURIComponent(request),
                dataType: 'json',
                success: function(json) {
                    response($.map(json, function(item) {
                        return {
    ...
    $('input[name=\'filter_information_name\']').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'index.php?route=appearance/menu/autocomplete&token=' + token + '&filter_information_name=' +  encodeURIComponent(request),
                dataType: 'json',
                success: function(json) {
                    response($.map(json, function(item) {
                        return {
