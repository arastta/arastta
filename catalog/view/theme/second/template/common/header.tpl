    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-<?php echo $logo_left_area; ?> hidden-xs">
                <div class="text-muted social-links"><?php if($theme_config->get('facebook_url')) : ?><a href="<?php echo $theme_config->get('facebook_url'); ?>" class="facebook"><span class="fa fa-2x fa-fw fa-facebook"></span></a><?php endif; ?> <?php if($theme_config->get('twitter_url')) : ?><a href="<?php echo $theme_config->get('twitter_url'); ?>" class="twitter"><span class="fa fa-2x fa-fw fa-twitter"></span></a><?php endif; ?> <?php if($theme_config->get('pinterest_url')) : ?><a href="<?php echo $theme_config->get('pinterest_url'); ?>" class="pinterest"><span class="fa fa-2x fa-fw fa-pinterest"></span></a><?php endif; ?> <?php if($theme_config->get('instagram_url')) : ?><a href="<?php echo $theme_config->get('instagram_url'); ?>" class="instagram"><span class="fa fa-2x fa-fw fa-instagram"></span></a><?php endif; ?></div>
            </div>
