...
$_['text_telephone']      = '<b>Telephone:</b> %s';
$_['text_product']        = '<b>Product:</b> %s';
$_['text_model']          = '<b>Model:</b> %s';
$_['text_quantity']       = '<b>Quantity:</b> %s';
$_['text_return_reason']  = '<b>Return Reason:</b> %s';
$_['text_opened']         = '<b>Opened:</b> %s';
