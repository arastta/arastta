...
class ControllerProductProduct extends Controller {
    ...
    public function index() {
        ...
        if ($product_info) {
            ...
            $this->document->addStyleDeclaration('.stock-status { color: ' . $stock_color . '; font-weight: bold;}');
            ...
            foreach ($this->model_catalog_product->getProductOptions($this->request->get['product_id']) as $option) {
                ...
                foreach ($option['product_option_value'] as $option_value) {
                    if (!$option_value['subtract'] || ($option_value['quantity'] > 0) || $this->config->get('config_stock_checkout') || $product_info['stock_preorder']) {
            ...
            $this->trigger->fire('pre.product.display', array(&$data, 'product'));
            ...
            foreach ($results as $result) {
                ...
                $this->trigger->fire('pre.product.display', array(&$result, 'related'));
