...
class ModelAntifraudMaxmind extends Model
{
    ...
    public function check($order_info)
    {
        ...
        $fraud_info = $this->getFraud($order_info['order_id']);
        ...
        if ($fraud_info) {
            ...
            */
            ...
            $request .= '&license_key=' . urlencode($this->config->get('maxmind_antifraud_key'));
        ...
        if ($risk_score > $this->config->get('maxmind_antifraud_score') && $this->config->get('maxmind_antifraud_key')) {
            return $this->config->get('maxmind_antifraud_order_status_id');
        }
    }
