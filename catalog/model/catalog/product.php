	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			return array(
				...
				'stock_status'     => $stock_status->num_rows ? $stock_status->row['name'] : '',
				'stock_color'      => $stock_status->num_rows ? $stock_status->row['color'] : '#ddd',
