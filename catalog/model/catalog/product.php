...
class ModelCatalogProduct extends Model {
    ...
    public function getProduct($product_id) {
        ...
        if ($query->num_rows) {
            $stock_status_color = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "stock_status WHERE stock_status_id = '" . $query->row['stock_status_id'] . "' AND language_id = '" . (int)$this->config->get('config_language_id') . "'");
            ...
            return array(
                ...
                'stock_color'      => $stock_status_color->num_rows ? $stock_status_color->row['color'] : '#ddd',
